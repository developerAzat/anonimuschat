     ...
     */ !(function () {
      ...
      (C.version = '2.3.9'),
        ...
        (C.TokenSet.fromArray = function (e) {
          for (var t = new C.TokenSet.Builder(), r = 0, n = e.length; r < n; r++)
            t.insert(e[r]);
        ...
        (C.TokenSet.fromFuzzyString = function (e, t) {
          for (
            var r = new C.TokenSet(), n = [{ node: r, editsRemaining: t, str: e }];
            n.length;
        ...
        (C.Builder.prototype.add = function (e, t) {
          ...
          for (var i = 0; i < n.length; i++) {
            ...
            for (var d = 0; d < l.length; d++) {
              var f = l[d];
              if (
                (null == h[f] && (h[f] = 0), (h[f] += 1), null == this.invertedIndex[f])
              ) {
        ...
        (C.MatchData.prototype.add = function (e, t, r) {
          if (!(e in this.metadata))
            return (
              (this.metadata[e] = Object.create(null)), void (this.metadata[e][t] = r)
            );
